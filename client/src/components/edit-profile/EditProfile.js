            ...
            <div className="create-profile">
                <div className="container">
                    <div className="row">
                        ...
                        <Link to="/dashboard" className="btn btn-light"><i className="far fa-arrow-alt-circle-left fa-2x"></i></Link>
                            ...
                            <form onSubmit={this.onSubmit}>
                                <TextFieldGroup
                                    ...
                                    onChange={this.onChange}
                                    error={errors.handle}
                                    info="A unique hanlde for your profile URL. Your full name, company name"/>
                                <SelectListGroup
                                    placeholder="status"
                                    name="status"
